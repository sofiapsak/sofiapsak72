...
for row in range(2, sheet.max_row + 1):
  sql = "INSERT INTO step_1 (Column2, Column3, Column4, Column5, Column6, Column7, Column8, Column9, Column10, Column11, Column12, Column13, Column14, Column15, Column16, Column17, Column18, Column19, Column20, Column21, Column22, Column23, Column24, Column25, Column26, Column27, Column28, Column29, Column30, Column31, Column32, Column33, Column34, Column35, Column36, Column37, Column38, Column39, Column40, Column41, Column42, Column43, Column44, Column45, Column46, Column47) VALUES "
  sql += f"( '{sheet.cell(row, 	1	).value}', '{sheet.cell(row, 	2	).value}', '{sheet.cell(row, 	3	).value}', '{sheet.cell(row, 	4	).value}', '{sheet.cell(row, 	5	).value}', '{sheet.cell(row, 	6	).value}', '{sheet.cell(row, 	7	).value}', '{sheet.cell(row, 	8	).value}', '{sheet.cell(row, 	9	).value}', '{sheet.cell(row, 	10	).value}', '{sheet.cell(row, 	11	).value}', '{sheet.cell(row, 	12	).value}', '{sheet.cell(row, 	13	).value}', '{sheet.cell(row, 	14	).value}', '{sheet.cell(row, 	15	).value}', '{sheet.cell(row, 	16	).value}', '{sheet.cell(row, 	17	).value}', '{sheet.cell(row, 	18	).value}', '{sheet.cell(row, 	19	).value}', '{sheet.cell(row, 	20	).value}', '{sheet.cell(row, 	21	).value}', '{sheet.cell(row, 	22	).value}', '{sheet.cell(row, 	23	).value}', '{sheet.cell(row, 	24	).value}', '{sheet.cell(row, 	25	).value}', '{sheet.cell(row, 	26	).value}', '{sheet.cell(row, 	27	).value}', '{sheet.cell(row, 	28	).value}', '{sheet.cell(row, 	29	).value}', '{sheet.cell(row, 	30	).value}', '{sheet.cell(row, 	31	).value}', '{sheet.cell(row, 	32	).value}', '{sheet.cell(row, 	33	).value}', '{sheet.cell(row, 	34	).value}', '{sheet.cell(row, 	35	).value}', '{sheet.cell(row, 	36	).value}', '{sheet.cell(row, 	37	).value}', '{sheet.cell(row, 	38	).value}', '{sheet.cell(row, 	39	).value}', '{sheet.cell(row, 	40	).value}', '{sheet.cell(row, 	41	).value}', '{sheet.cell(row, 	42	).value}', '{sheet.cell(row, 	43	).value}', '{sheet.cell(row, 	44	).value}', '{sheet.cell(row, 	45	).value}', '{sheet.cell(row, 	47	).value}')"
  cur.execute(sql)
...
# (C) IMPORT ROWS & COLUMNS
for row in range(2, sheet.max_row + 1):
  sql = "INSERT INTO step_2 (Column2_2, Column2_3, Column2_4, Column2_5, Column2_6, Column2_7, Column2_8, Column2_9, Column2_10, Column2_11, Column2_12, Column2_13, Column2_14, Column2_15, Column2_16, Column2_17, Column2_18, Column2_19, Column2_20, Column2_21, Column2_22, Column2_23, Column2_24, Column2_25, Column2_26, Column2_27, Column2_28, Column2_29, Column2_30) VALUES "
  sql += f"('{sheet.cell(row,  1   ).value}', '{sheet.cell(row,    2   ).value}', '{sheet.cell(row,    3   ).value}', '{sheet.cell(row,    4   ).value}', '{sheet.cell(row,    5   ).value}', '{sheet.cell(row,    6   ).value}', '{sheet.cell(row,    7   ).value}', '{sheet.cell(row,    8   ).value}', '{sheet.cell(row,    9   ).value}', '{sheet.cell(row,    10  ).value}', '{sheet.cell(row,    11  ).value}', '{sheet.cell(row,    12  ).value}', '{sheet.cell(row,    13  ).value}', '{sheet.cell(row,    14  ).value}', '{sheet.cell(row,    15  ).value}', '{sheet.cell(row,    16  ).value}', '{sheet.cell(row,    17  ).value}', '{sheet.cell(row,    18  ).value}', '{sheet.cell(row,    19  ).value}', '{sheet.cell(row,    20  ).value}', '{sheet.cell(row,    21  ).value}', '{sheet.cell(row,    22  ).value}', '{sheet.cell(row,    23  ).value}', '{sheet.cell(row,    24  ).value}', '{sheet.cell(row,    25  ).value}', '{sheet.cell(row,    26  ).value}', '{sheet.cell(row,    27  ).value}', '{sheet.cell(row,    28  ).value}', '{sheet.cell(row,    29  ).value}')"
  cur.execute(sql)
...
# (C) IMPORT ROWS & COLUMNS
for row in range(2, sheet.max_row + 1):
  sql = "INSERT INTO step_3 (Column3_2, Column3_3, Column3_4, Column3_5, Column3_6, Column3_7, Column3_8, Column3_9, Column3_10, Column3_11, Column3_12, Column3_13, Column3_14, Column3_15, Column3_16, Column3_17, Column3_18, Column3_19, Column3_20, Column3_21, Column3_22, Column3_23, Column3_24, Column3_25, Column3_26, Column3_27, Column3_28, Column3_29, Column3_30, Column3_31, Column3_32, Column3_33, Column3_34, Column3_35, Column3_36, Column3_37) VALUES "
  sql += f"('{sheet.cell(row, 	1	).value}', '{sheet.cell(row, 	2	).value}', '{sheet.cell(row, 	3	).value}', '{sheet.cell(row, 	4	).value}', '{sheet.cell(row, 	5	).value}', '{sheet.cell(row, 	6	).value}', '{sheet.cell(row, 	7	).value}', '{sheet.cell(row, 	8	).value}', '{sheet.cell(row, 	9	).value}', '{sheet.cell(row, 	10	).value}', '{sheet.cell(row, 	11	).value}', '{sheet.cell(row, 	12	).value}', '{sheet.cell(row, 	13	).value}', '{sheet.cell(row, 	14	).value}', '{sheet.cell(row, 	15	).value}', '{sheet.cell(row, 	16	).value}', '{sheet.cell(row, 	17	).value}', '{sheet.cell(row, 	18	).value}', '{sheet.cell(row, 	19	).value}', '{sheet.cell(row, 	20	).value}', '{sheet.cell(row, 	21	).value}', '{sheet.cell(row, 	22	).value}', '{sheet.cell(row, 	23	).value}', '{sheet.cell(row, 	24	).value}', '{sheet.cell(row, 	25	).value}', '{sheet.cell(row, 	26	).value}', '{sheet.cell(row, 	27	).value}', '{sheet.cell(row, 	28	).value}', '{sheet.cell(row, 	29	).value}', '{sheet.cell(row, 	30	).value}', '{sheet.cell(row, 	31	).value}', '{sheet.cell(row, 	32	).value}', '{sheet.cell(row, 	33	).value}', '{sheet.cell(row, 	34	).value}', '{sheet.cell(row, 	35	).value}', '{sheet.cell(row, 	36	).value}')"
  cur.execute(sql)
...
# (C) IMPORT ROWS & COLUMNS
for row in range(2, sheet.max_row + 1):
  sql = "INSERT INTO step_4 (Column4_2, Column4_3, Column4_4, Column4_5, Column4_6, Column4_7, Column4_8, Column4_9, Column4_10, Column4_11, Column4_12, Column4_13, Column4_14, Column4_15, Column4_16, Column4_17, Column4_18, Column4_19, Column4_20, Column4_21, Column4_22, Column4_23, Column4_24, Column4_25, Column4_26, Column4_27, Column4_28, Column4_29, Column4_30, Column4_31, Column4_32, Column4_33) VALUES "
  sql += f"('{sheet.cell(row, 	1	).value}', '{sheet.cell(row, 	2	).value}', '{sheet.cell(row, 	3	).value}', '{sheet.cell(row, 	4	).value}', '{sheet.cell(row, 	5	).value}', '{sheet.cell(row, 	21	).value}', '{sheet.cell(row, 	22	).value}', '{sheet.cell(row, 	23	).value}', '{sheet.cell(row, 	24	).value}', '{sheet.cell(row, 	25	).value}', '{sheet.cell(row, 	26	).value}', '{sheet.cell(row, 	27	).value}', '{sheet.cell(row, 	28	).value}', '{sheet.cell(row, 	29	).value}', '{sheet.cell(row, 	30	).value}', '{sheet.cell(row, 	31	).value}', '{sheet.cell(row, 	32	).value}', '{sheet.cell(row, 	33	).value}', '{sheet.cell(row, 	34	).value}', '{sheet.cell(row, 	35	).value}', '{sheet.cell(row, 	36	).value}', '{sheet.cell(row, 	37	).value}', '{sheet.cell(row, 	38	).value}', '{sheet.cell(row, 	39	).value}', '{sheet.cell(row, 	40	).value}', '{sheet.cell(row, 	41	).value}', '{sheet.cell(row, 	42	).value}', '{sheet.cell(row, 	43	).value}', '{sheet.cell(row, 	44	).value}', '{sheet.cell(row, 	45	).value}', '{sheet.cell(row, 	46	).value}', '{sheet.cell(row, 	47	).value}')"
  cur.execute(sql)
...
# (C) IMPORT ROWS & COLUMNS
for row in range(2, sheet.max_row + 1):
  sql = "INSERT INTO comp_adj_per_kontrak (Column6_2, Column6_3, Column6_4, Column6_5, Column6_6, Column6_7, Column6_8, Column6_9, Column6_10, Column6_11, Column6_12, Column6_13, Column6_14, Column6_15, Column6_16, Column6_17, Column6_18, Column6_19, Column6_20, Column6_21, Column6_22) VALUES "
...
# (C) IMPORT ROWS & COLUMNS
for row in range(2, sheet.max_row + 1):
  sql = "INSERT INTO comp_adj_per_gl (Column7_2, Column7_3, Column7_4, Column7_5, Column7_6, Column7_7, Column7_8, Column7_9, Column7_10, Column7_11, Column7_12, Column7_13, Column7_14, Column7_15, Column7_16, Column7_17, Column7_18, Column7_19, Column7_20, Column7_21) VALUES "
  sql += f"('{sheet.cell(row, 	2	).value}', '{sheet.cell(row, 	3	).value}', '{sheet.cell(row, 	4	).value}', '{sheet.cell(row, 	5	).value}', '{sheet.cell(row, 	6	).value}', '{sheet.cell(row, 	7	).value}', '{sheet.cell(row, 	8	).value}', '{sheet.cell(row, 	9	).value}', '{sheet.cell(row, 	10	).value}', '{sheet.cell(row, 	11	).value}', '{sheet.cell(row, 	12	).value}', '{sheet.cell(row, 	13	).value}', '{sheet.cell(row, 	14	).value}', '{sheet.cell(row, 	15	).value}', '{sheet.cell(row, 	16	).value}', '{sheet.cell(row, 	17	).value}', '{sheet.cell(row, 	18	).value}', '{sheet.cell(row, 	19	).value}', '{sheet.cell(row, 	20	).value}', '{sheet.cell(row, 	21	).value}')"
  cur.execute(sql)
...
# (C) IMPORT ROWS & COLUMNS
for row in range(2, sheet.max_row + 1):
  sql = "INSERT INTO kk_44_q3_2022 (Column8_2, Column8_3, Column8_4, Column8_5, Column8_6, Column8_7, Column8_8, Column8_9, Column8_10, Column8_11, Column8_12, Column8_13, Column8_14, Column8_15, Column8_16, Column8_17, Column8_18, Column8_19) VALUES "
  ...
  cur.execute(sql)
print(" - DATA STEP KK 4.4_Q3 2022 BERSHASIL DITAMBAHKAN")
conn.commit()
conn.close()
...
# (C) IMPORT ROWS & COLUMNS
for row in range(2, sheet.max_row + 1):
  sql = "INSERT INTO comp_summary_of_unsatisfied_po (Column9_2, Column9_3, Column9_4, Column9_5, Column9_6, Column9_7, Column9_8, Column9_9, Column9_10, Column9_11, Column9_12, Column9_13, Column9_14, Column9_15, Column9_16) VALUES "
  sql += f"('{sheet.cell(row, 	2	).value}', '{sheet.cell(row, 	3	).value}', '{sheet.cell(row, 	4	).value}', '{sheet.cell(row, 	5	).value}', '{sheet.cell(row, 	6	).value}', '{sheet.cell(row, 	7	).value}', '{sheet.cell(row, 	8	).value}', '{sheet.cell(row, 	9	).value}', '{sheet.cell(row, 	10	).value}', '{sheet.cell(row, 	11	).value}', '{sheet.cell(row, 	12	).value}', '{sheet.cell(row, 	13	).value}', '{sheet.cell(row, 	14	).value}', '{sheet.cell(row, 	15	).value}', '{sheet.cell(row, 	16	).value}')"
  cur.execute(sql)
...
# (C) IMPORT ROWS & COLUMNS
for row in range(2, sheet.max_row + 1):
  sql = "INSERT INTO proyeksi_revenue (Column10_2, Column10_3, Column10_4, Column10_5, Column10_6, Column10_7, Column10_8, Column10_9, Column10_10) VALUES "
  sql += f"('{sheet.cell(row, 	2	).value}', '{sheet.cell(row, 	3	).value}', '{sheet.cell(row, 	4	).value}', '{sheet.cell(row, 	5	).value}', '{sheet.cell(row, 	6	).value}', '{sheet.cell(row, 	7	).value}', '{sheet.cell(row, 	8	).value}', '{sheet.cell(row, 	9	).value}', '{sheet.cell(row, 	10	).value}')"
  cur.execute(sql)
...
# (C) IMPORT ROWS & COLUMNS
for row in range(2, sheet.max_row + 1):
  sql = "INSERT INTO alokasi_cacl_per_bp_number (Column11_2, Column11_3, Column11_4, Column11_5, Column11_6, Column11_7, Column11_8, Column11_9, Column11_10, Column11_11, Column11_12, Column11_13, Column11_14, Column11_15, Column11_16, Column11_17, Column11_18, Column11_19, Column11_20, Column11_21, Column11_22, Column11_23, Column11_24, Column11_25) VALUES "
  sql += f"('{sheet.cell(row, 	1	).value}', '{sheet.cell(row, 	2	).value}', '{sheet.cell(row, 	3	).value}', '{sheet.cell(row, 	4	).value}', '{sheet.cell(row, 	5	).value}', '{sheet.cell(row, 	6	).value}', '{sheet.cell(row, 	7	).value}', '{sheet.cell(row, 	8	).value}', '{sheet.cell(row, 	9	).value}', '{sheet.cell(row, 	10	).value}', '{sheet.cell(row, 	11	).value}', '{sheet.cell(row, 	12	).value}', '{sheet.cell(row, 	13	).value}', '{sheet.cell(row, 	14	).value}', '{sheet.cell(row, 	15	).value}', '{sheet.cell(row, 	16	).value}', '{sheet.cell(row, 	17	).value}', '{sheet.cell(row, 	18	).value}', '{sheet.cell(row, 	19	).value}', '{sheet.cell(row, 	20	).value}', '{sheet.cell(row, 	21	).value}', '{sheet.cell(row, 	22	).value}', '{sheet.cell(row, 	23	).value}', '{sheet.cell(row, 	24	).value}')"
  cur.execute(sql)
