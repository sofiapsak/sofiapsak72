...
?>
	<?php require('application/views/load/leftbar_step12.php');?>
	
	<?php require('application/views/load/rightbar.php');?>

	<?php if($this->session->userdata('level')==='1'):?>
	<?php require('application/views/load/filemanager.php');?>
	
	<?php else:?>
	<?php require('application/views/load/filemanager_user.php');?>
	<?php endif;?>
