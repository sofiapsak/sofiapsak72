 ...
 <aside class="sidenav-main nav-expanded nav-lock nav-collapsible sidenav-dark sidenav-active-rounded">
      ...
      <ul class="sidenav sidenav-collapsible leftside-navigation collapsible sidenav-fixed menu-shadow" id="slide-out" data-menu="menu-navigation" data-collapsible="accordion">
        ...
        <li class="active bold"><a class="waves-effect waves-cyan active" href="<?php echo base_url('home/data_comp_adj');?>"><i class="material-icons">format_list_bulleted</i><span class="menu-title" data-i18n="Contacts">Comp Adj Per Kontrak</span></a>
        </li>
        ...
        <li class="bold"><a class="waves-effect waves-cyan " href="<?php echo base_url('home/data_comp_summary');?>"><i class="material-icons">receipt</i><span class="menu-title" data-i18n="Contacts">Comp Summary of Unsatisfied PO</span></a>
        </li>
