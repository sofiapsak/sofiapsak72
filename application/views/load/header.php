      ...
      <div class="navbar navbar-fixed"> 
        <nav class="navbar-main navbar-color nav-collapsible sideNav-lock navbar-light">
          <div class="nav-wrapper">
            <div class="header-search-wrapper hide-on-med-and-down"><i style="font-size:16px;width:1000px;"> <b>IFRS 15 REVENUE FROM CONTRACTS WITH CUSTOMER</b></i>
          </div>
            <ul class="nav-wrapper right" style="width:301px;margin-top:-77px;">
            <li><a style="color:black;"><?php echo date('d / M / y'); ?> &nbsp; <?php date_default_timezone_set("Asia/Jakarta"); echo date('H:i:s'); ?></a></li>
              <li class="hide-on-med-and-down"><a class="waves-effect waves-block waves-light toggle-fullscreen" href="javascript:void(0);"><i class="material-icons">settings_overscan</i></a></li>
              <!--<li class="hide-on-large-only search-input-wrapper"><a class="waves-effect waves-block waves-light search-button" href="javascript:void(0);"><i class="material-icons">search</i></a></li>
              <li><a class="waves-effect waves-block waves-light notification-button" href="javascript:void(0);" data-target="notifications-dropdown"><i class="material-icons">notifications_none<small class="notification-badge">5</small></i></a></li>-->
              <li><a class="waves-effect waves-block waves-light profile-button" href="javascript:void(0);" data-target="profile-dropdown"><i class="material-icons">person_outline</i></a></li>
              <!--<li><a class="waves-effect waves-block waves-light sidenav-trigger" href="#" data-target="slide-out-right"><i class="material-icons">business</i></a></li>-->
            </ul>
            ...
            <ul class="dropdown-content" id="profile-dropdown">
              <li><a class="grey-text text-darken-1" href="#"><i class="material-icons">person_outline</i> <?php echo $this->session->userdata('username');?></a></li>
              <li><a class="grey-text text-darken-1" href="<?php echo site_url('register');?>"><i class="material-icons">person_add</i> Register</a></li>
